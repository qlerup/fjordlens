...
const I18N = {
  da: {
    ...
    upload_workflow_aggressive_desc: 'Kører faser parallelt og sender ansigtsbilleder samlet til AI-servicen.',
    upload_workflow_extra_info: 'Thumbnail runtime: {thumb_runtime} · Ansigtsbatch: {batch_size} · AI-service batch',
  ...
  en: {
    ...
    upload_workflow_aggressive_desc: 'Runs phases in parallel and sends face images to the AI service in batches.',
    upload_workflow_extra_info: 'Thumbnail runtime: {thumb_runtime} · Face batch: {batch_size} · AI-service batch',
